<?php
    ...
    $rol = new Rol();
    $datos = $rol->validar_menu_x_rol($_SESSION["rol_id"], "mantenimientotipo");
...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8">
        <title>Mantenimiento Tipo de Persona | Mesa de Partes Virtual - DREI</title>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Mantenimiento Tipo de Usuarios</h4>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <h4 class="card-title">Listado de Tipos de Usuarios (Cliente)</h4>
                                                <p class="card-title-desc">(*) Vista para listar, registrar, modificar y eliminar tipos de Usuarios. </p>
                                            </div>
                                            <div class="card-body">
                                            ...
                                            <br></br>
                                                ...
                                                <table id="listado_tipo" class="table table-bordered dt-responsive nowrap w-100">
                                                        <thead>
                                                            <tr>
                                                                <th>Nombre</th>
