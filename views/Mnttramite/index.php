<?php
    ...
    $rol = new Rol();
    $datos = $rol->validar_menu_x_rol($_SESSION["rol_id"], "mantenimientotramite");
...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8">
        <title>Mantenimiento Trámites | Mesa de Partes Virtual - DREI</title>
    ...
    <!-- <body data-layout="horizontal"> -->
        ...
        <div id="layout-wrapper">
            ...
            <div class="main-content">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <h4 class="card-title">Listado de Tipos de Tramites (Usuario)</h4>
                                                <p class="card-title-desc">(*) Vista para listar, registrar, modificar y eliminar tipos de trámites a recibir. </p>
                                            </div>
                                            <div class="card-body">
                                            ...
                                            <br></br>
                                                ...
                                                <table id="listado_tramite" class="table table-bordered dt-responsive nowrap w-100">
                                                        <thead>
                                                            <tr>
                                                                <th>Nombre</th>
                                                                <th>Descripcion</th>
                ...
                <!-- End Page-content -->
                <?php require_once ("mnttramite.php");?>
        ...
        <script src="mnttramite.js"></script>
