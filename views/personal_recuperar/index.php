...
<html lang="en">
    ...
    <!-- <body data-layout="horizontal"> -->
                                ...
                                <div class="d-flex flex-column h-100">
                                    ...
                                    <div class="auth-content my-auto">
                                        <div class="text-center">
                                            <h5 class="mb-0">Recuperar Contraseña (Personal)</h5>
                                        ...
                                        <div class="mt-5 text-center">
                                            <p class="text-muted mb-0">Regrsar a  <a href="<?php echo BASE_URL . 'views/personal_login/index.php';?>" class="text-primary fw-semibold"> Acceder </a> </p>
                                        </div>
                                    </div>
        ...
        <script type="text/javascript" src="personal_recuperar.js"></script>
    </body>
