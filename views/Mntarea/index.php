<?php
    ...
    $rol = new Rol();
    $datos = $rol->validar_menu_x_rol($_SESSION["rol_id"], "mantenimientoarea");
...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8">
        <title>Mantenimiento Area | Mesa de Partes Virtual - DREI</title>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <h4 class="card-title">Listado de Tipos de Areas (Personal)</h4>
                                                <p class="card-title-desc">(*) Vista para listar, registrar, modificar y eliminar tipos de áreas de la organización. </p>
                                            </div>
                                            <div class="card-body">
                                            ...
                                            <br></br>
                                                ...
                                                <table id="listado_area" class="table table-bordered dt-responsive nowrap w-100">
                                                        <thead>
                                                            <tr>
                                                                <th>Nombre</th>
                                                                <th>Correo</th>
