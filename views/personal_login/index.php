...
<html lang="en">
    ...
    <!-- <body data-layout="horizontal"> -->
                                ...
                                <div class="d-flex flex-column h-100">
                                    ...
                                    <div class="auth-content my-auto">
                                        <div class="text-center">
                                            <h5 class="mb-0">Mesa de Partes (Personal)</h5>
                                            <p class="text-muted mt-2">Ingrese sus credenciales de Personal.</p>
                                        </div>
                                            ...
                                            <div class="mb-3">
                                                <div class="d-flex align-items-start">
                                                    ...
                                                    <div class="flex-shrink-0">
                                                        <div class="">
                                                            <a href="<?php echo BASE_URL . 'views/personal_recuperar/index.php';?>" class="text-muted">Olvidaste tu contraseña?</a>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="mt-4 mt-md-5 text-center">
                                        <p class="mb-0">© <script>document.write(new Date().getFullYear())</script> Zero. <i class="mdi mdi-heart text-danger"></i> Code</p>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <script src="acceso_personal.js"></script>
    </body>
