...
?>
    ...
    <head>
        ...
        <meta charset="utf-8">
        <title>Gestionar Trámites | Mesa de Partes Virtual - DREI</title>
        <!-- DataTables -->
    ...
    <body>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <h4 class="card-title">Listado de los Tramites Recibidos (Usuario)</h4>
        ...
        <script src="gestionar_tramite.js"></script>
    </body>
