                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <form method="post" id="documento_respuesta">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="mb-2">
                                                ...
                                                <textarea class="form-control" type="text" placeholder="Escriba aquí la respuesta del trámite" value="" rows=2 name="doc_respuesta" id="doc_respuesta" required></textarea>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div>
                                                <div action="#" class="dropzone">
                                                    ...
                                                    <div class="dz-message needsclick">
                                                        ...
                                                        <h5>Adjunte documentos si es necesario(*). <br>Arrastre archivos aquí o hacer click para subir.</h5>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-flex flex-wrap gap-2 mt-4 justify-content-end">
                                            ...
                                            <button type="submit" id="btnenviar" class="btn btn-primary waves-effect waves-light">Responder</button>
