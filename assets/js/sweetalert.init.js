document.getElementById("sa-basic").addEventListener("click", function () {
        ...
        var e; Swal.fire({
            ...
            didOpen: function () {
                Swal.showLoading(), e = setInterval(function () {
                    var e = Swal.getHtmlContainer(); !e || (e = e.querySelector("b")) && (e.textContent = Swal.getTimerLeft())
                }, 100)
            }, onClose: function () { clearInterval(e) }
        }).then(function (e) { e.dismiss === Swal.DismissReason.timer && console.log("I was closed by the timer") })
    }),
    ...
    document.getElementById("ajax-alert").addEventListener("click", function () {
        Swal.fire({
            ...
            input: "email", showCancelButton: !0,
            confirmButtonText: "Submit",
            showLoaderOnConfirm: !0,
            confirmButtonColor: "#5156be",
            cancelButtonColor: "#fd625e", preConfirm: function (n) { return new Promise(function (e, t) { setTimeout(function () { "taken@example.com" === n ? t("This email is already taken.") : e() }, 2e3) }) }, allowOutsideClick: !1
        }).then(function (e) { Swal.fire({ icon: "success", title: "Ajax request finished!", confirmButtonColor: "#5156be", html: "Submitted email: " + e }) })
    });
